...
class Project(models.Model):
    ...
    system = models.ForeignKey(System, blank=True, null=True, related_name="projects", on_delete=models.SET_NULL, help_text="The IT System to which this Projectis associated.")
